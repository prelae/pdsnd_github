...
def get_filters():
    ...
    # TO DO: get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs as well as capitalized or uncapitalized text and other mistakes
